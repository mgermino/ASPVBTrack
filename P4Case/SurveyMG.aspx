<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SurveyMG.aspx.vb" Inherits="Request" ViewStateMode = "Disabled" %>
...
<body>
    <form id="form1" runat="server" defaultbutton="btnMGSubmit" defaultfocus="txtMGName">
    <div id="page">
